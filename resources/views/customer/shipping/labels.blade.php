                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('customer.shipping.show', $label->shipment) }}" class="text-decoration-none">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('customer.shipping.labels.download', $label) }}" 
...
$(document).ready(function() {
    ...
    $('.view-label').click(function() {
        ...
        $.get(`/customer/shipping/labels/${labelId}/preview`, function(response) {
    ...
    $('.delete-label').click(function() {
        ...
        if (confirm('Are you sure you want to delete this shipping label?')) {
            $.ajax({
                url: `/customer/shipping/labels/${labelId}`,
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
    ...
    $('#downloadAll').click(function() {
        ...
        window.location.href = '{{ route("customer.shipping.labels.download-all") }}?ids=' + selectedLabels.join(',');
    });
    ...
    $('#deleteAll').click(function() {
        ...
        if (confirm('Are you sure you want to delete the selected shipping labels?')) {
            $.ajax({
                url: '{{ route("customer.shipping.labels.delete-all") }}',
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}',
                    ids: selectedLabels
